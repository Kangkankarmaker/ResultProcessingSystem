...
public class Manage_result_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.listView_manage_stu);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                /*startActivity(new Intent(Manage_result_Activity.this,Manage_result_2_Activity.class)
                        .putExtra("details", Response));*/

                startActivity(new Intent(Manage_result_Activity.this,Edit_result_Activity.class)
                        .putExtra("details", Response));
        ...
        call.enqueue(new Callback<List<student_responce>>() {
            ...
            public void onResponse(Call<List<student_responce>> call, Response<List<student_responce>> response) {
                if (response.code() == 200){
                    ...
                    studentAdapter = new listAdapter(Manage_result_Activity.this, student);
            ...
            public void onFailure(Call<List<student_responce>> call, Throwable t) {
                Toast.makeText(Manage_result_Activity.this, "Failed to connect Database..", Toast.LENGTH_SHORT).show();
                pDialog.dismiss();
            }
        });
    }
    private void displayLoader() {
        pDialog = new ProgressDialog(Manage_result_Activity.this);
