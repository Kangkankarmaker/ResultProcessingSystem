...
public class Add_second_semester_result_Activity extends AppCompatActivity {

    AutoCompleteTextView ext_stu_reg,ext_sub_1,ext_sub_2,ext_sub_3,ext_sub_4,ext_sub_5,ext_sub_6,ext_sub_7;
    Button add_data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_second_semester_result);

        if(!isConnected(Add_second_semester_result_Activity.this)) buildDialog(Add_second_semester_result_Activity.this).show();


        ArrayAdapter adapter = new ArrayAdapter(this, android.R.layout.simple_list_item_1, languages);

        ext_stu_reg=findViewById(R.id.ext_stu_reg_second);
        ext_sub_1=findViewById(R.id.cse_121);
        ext_sub_2=findViewById(R.id.cse_122);
        ext_sub_3=findViewById(R.id.cse_123);
        ext_sub_4=findViewById(R.id.cse_124);
        ext_sub_5=findViewById(R.id.cse_125);
        ext_sub_6=findViewById(R.id.cse_126);
        ext_sub_7=findViewById(R.id.cse_127);
        ...
        ext_sub_7.setAdapter(adapter);
        ext_sub_7.setThreshold(1);

        add_data=findViewById(R.id.btn_add_second_result);
        add_data.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String stu_regs,sub1,sub2,sub3,sub4,sub5,sub6,sub7;
                ...
                sub7=ext_sub_7.getText().toString();

                if (validateInputs()) {
                    insert_second_result(stu_regs,sub1,sub2,sub3,sub4,sub5,sub6,sub7);
                    displayLoader();
                }
    ...
    private void insert_second_result(String stu_regs, String sub1, String sub2, String sub3, String sub4, String sub5, String sub6, String sub7) {
        ...
        Call<second_semester_result_response> call =service.insert_second_result(stu_regs,sub1,sub2,sub3,sub4,sub5,sub6,sub7);
        call.enqueue(new Callback<second_semester_result_response>() {
            @Override
            public void onResponse(Call<second_semester_result_response> call, Response<second_semester_result_response> response) {
            ...
            @Override
            public void onFailure(Call<second_semester_result_response> call, Throwable t) {

                Toast.makeText(Add_second_semester_result_Activity.this,"Student Result Added",Toast.LENGTH_LONG).show();
                pDialog.dismiss();
                Intent i = new Intent(Add_second_semester_result_Activity.this, DashboardActivity.class);
                startActivity(i);
                finish();
            }
    ...
    private boolean validateInputs() {
        ...
        if(ext_sub_7.length() == 0){
            ext_sub_7.setError("This part can not be empty");
            ext_sub_7.requestFocus();
            return false;
        }
        return true;
    }
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(Add_second_semester_result_Activity.this);
